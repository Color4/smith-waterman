...
import itertools
from main.false_positives import calculate_pos_rate, fpr, tpr
...
if __name__ == "__main__":
    ...
    positive_pairs = read_sequence_pairs("../test_neg.txt")
    negative_pairs = read_sequence_pairs("../test_pos.txt")
